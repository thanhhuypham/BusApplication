...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyAKUzmUOwaS3KJrE0JlgVLGh8CUIakIZJ0";
    private DirectionFinderListener directionFinderListener;
    private String origin;
    private String destination;

    public DirectionFinder(DirectionFinderListener listener, String origin, String destination) {
        this.directionFinderListener = listener;
        this.origin = origin;
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        ArrayList<Route> arrRoute = new ArrayList<Route>();
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            JSONObject jsonItems = jsonRoute.getJSONObject("overview_polyline");
            ...
            route.points = decodePolyLine(jsonItems.getString("points"));

            arrRoute.add(route);
        }

        directionFinderListener.onDirectionFinderSuccess(arrRoute);
    }
